...
8. Mettre à jour `<dossier>/README.md` :
   - Refléter l'état actuel du projet (stack, objectif, état d'avancement) si des éléments ont changé pendant la session.
   - Ne pas toucher au fichier si rien n'a évolué.
